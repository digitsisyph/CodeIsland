...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "completion_style": "Reminder style",
        "completion_chime": "Chime",
        "completion_speech": "Speech",
        "speech_voice": "Voice",
        "speech_default": "Chinese · System voice",
        "sound_preview": "Preview",
        "speech_stop": "Stop speaking",
        "completion_description": "Announce the service and session name once when a reply finishes.",
        "coffee_title": "Keep awake",
        "coffee_enabled": "Keep this Mac awake",
        "coffee_display": "Also keep the display awake",
        "coffee_description": "Coffee mode prevents automatic sleep until you turn it off or quit CodeIsland. The display can turn off unless enabled above. Closing the lid or choosing Sleep can still put this Mac to sleep.",
        "coffee_enable": "Keep awake · no time limit",
        "coffee_disable": "Keep awake is on · click to turn off",
        "coffee_off": "Off",
        "coffee_error": "Could not keep this Mac awake. Try turning coffee mode on again.",
        "icloud": "iCloud Sync",
        "icloud_enable": "Sync across my Macs",
        "icloud_usage": "Sync account quotas",
        "icloud_preferences": "Sync quota display settings",
        "icloud_description": "Uses iCloud Drive on Macs signed in to the same Apple Account. Quotas refresh in the background every minute while enabled. Only quota measurements and the display settings below are shared; login credentials stay on this Mac.",
        "icloud_unavailable": "Turn on iCloud Drive in System Settings to enable sync.",
        "icloud_io_error": "Could not access the sync folder. Check iCloud Drive and available storage, then retry.",
        "icloud_sync_now": "Sync now",
        "icloud_uploaded": "Uploaded to iCloud",
        "icloud_pending": "Saved locally · waiting for iCloud",
        "icloud_display": "Quota display",
        "icloud_hide_spark": "Hide Codex Spark quotas",
        "icloud_countdown": "Show reset countdowns",
        "icloud_provider_first": "Show first",
        "icloud_devices": "Macs",
        "icloud_no_devices": "No synced Macs yet.",
        "icloud_this_mac": "This Mac",
        "icloud_via": "Via",
        "quota_tab": "Quota",
        "quota_refresh": "Refresh",
        "quota_left": "left",
        "quota_countdown_days": "%dd %dh left",
        "quota_countdown_hours": "%dh %dm left",
    ...
    private static let zh: [String: String] = [
        "completion_reminder": "完成提醒",
        "completion_style": "提醒方式",
        "completion_chime": "提示音",
        "completion_speech": "语音播报",
        "speech_voice": "播报声音",
        "speech_default": "中文 · 系统声音",
        "sound_preview": "试听",
        "speech_stop": "停止播报",
        "completion_description": "每轮回复完成时提醒一次，语音会读出服务和会话名称。",
        "coffee_title": "保持唤醒",
        "coffee_enabled": "保持电脑运行",
        "coffee_display": "同时保持屏幕常亮",
        "coffee_description": "咖啡模式会阻止电脑自动睡眠，直到手动关闭或退出 CodeIsland。默认允许熄屏；合盖或手动选择睡眠仍可使电脑睡眠。",
        "coffee_enable": "开启保持唤醒 · 不限时",
        "coffee_disable": "正在保持唤醒 · 点击关闭",
        "coffee_off": "已关闭",
        "coffee_error": "未能开启保持唤醒，请重试。",
        "icloud": "iCloud 同步",
        "icloud_enable": "在我的多台 Mac 之间同步",
        "icloud_usage": "同步账号额度",
        "icloud_preferences": "同步额度显示设置",
        "icloud_description": "通过 iCloud 云盘同步到使用同一 Apple 账户的 Mac。开启后每分钟在后台刷新额度，仅共享额度数据和下方的显示设置，登录凭证保留在本机。",
        "icloud_unavailable": "请在系统设置中开启 iCloud 云盘后使用同步。",
        "icloud_io_error": "无法访问同步文件夹，请检查 iCloud 云盘和剩余存储空间后重试。",
        "icloud_sync_now": "立即同步",
        "icloud_uploaded": "已上传 iCloud",
        "icloud_pending": "已保存本地 · 等待 iCloud 上传",
        "icloud_display": "额度显示",
        "icloud_hide_spark": "隐藏 Codex Spark 额度",
        "icloud_countdown": "显示重置倒计时",
        "icloud_provider_first": "优先显示",
        "icloud_devices": "Mac 设备",
        "icloud_no_devices": "暂无同步设备。",
        "icloud_this_mac": "本机",
        "icloud_via": "来自",
        "quota_tab": "额度",
        "quota_refresh": "刷新",
        "quota_left": "剩余",
        "quota_countdown_days": "剩余 %d 天 %d 小时",
        "quota_countdown_hours": "剩余 %d 小时 %d 分钟",
    ...
    private static let zhHant: [String: String] = [
        ...
        "completion_style": "提醒方式",
        "completion_chime": "提示音",
        "completion_speech": "語音播報",
        "speech_voice": "播報聲音",
        "speech_default": "中文 · 系統聲音",
        "sound_preview": "試聽",
        "speech_stop": "停止播報",
        "completion_description": "每輪回覆完成時提醒一次，語音會讀出服務和會話名稱。",
        "coffee_title": "保持喚醒",
        "coffee_enabled": "保持電腦運作",
        "coffee_display": "同時保持螢幕常亮",
        "coffee_description": "咖啡模式會阻止電腦自動睡眠，直到手動關閉或退出 CodeIsland。預設允許關閉螢幕；闔蓋或手動選擇睡眠仍可使電腦睡眠。",
        "coffee_enable": "開啟保持喚醒 · 不限時",
        "coffee_disable": "正在保持喚醒 · 點擊關閉",
        "coffee_off": "已關閉",
        "coffee_error": "未能開啟保持喚醒，請重試。",
        // Settings pages
        "general": "一般",
        "behavior": "行為",
        "appearance": "外觀",
